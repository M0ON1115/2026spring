/* KU STARTUP PLANNER - refactored front-end */
    ...
    const FRONTEND_VERSION =
      "20260625-memo-summary-tab-final";
    ...
    get("memoTabBtn")?.addEventListener(
      "click",
      () => {
        renderProjectMemo();
        renderValidationLogs();
